    ...
    <section className="px-4 py-10 md:px-8 lg:px-10">
      <div className="mx-auto max-w-screen-2xl space-y-8">
        <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
          ...
          <Link
            to="/products"
            className="min-w-fit rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm transition-all duration-300 hover:border-emerald-400 hover:text-emerald-600 hover:shadow-md"
          >
            View All Products
          </Link>
        </div>
          ...
          {loading ? (
            ...
            <>
              {products.slice(0, 8).map((item) => (
                <div
                  key={item._id}
                  className="group col-span-2 md:col-span-1 relative overflow-hidden rounded-3xl border border-gray-200 bg-white/90 shadow-sm backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl"
                >
                  ...
                  <div className="space-y-3 px-4 pb-4 pt-1">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-3 pt-1">
                      ...
                      <Link
                        ...
                        className="w-full md:w-fit rounded-xl bg-linear-to-r from-emerald-500 to-green-500 px-4 py-2.5 text-sm font-semibold text-white shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95"
                      >
                        View Details
                      </Link>
                    </div>
