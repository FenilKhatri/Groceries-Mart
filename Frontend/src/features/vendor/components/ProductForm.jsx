...
import LazySelect from "../../../shared/components/common/LazySelect";
...
const ProductForm = () => {
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      ...
      try {
        ...
        setUnit(
          product?.unit ? { value: product.unit, label: product.unit } : null,
        );
      } catch (error) {
  ...
  const handleForm = async (e) => {
    ...
    if (!isEditMode) {
      ...
      if (!thumbnail) return toast.error("Please select thumbnail!");
    }
