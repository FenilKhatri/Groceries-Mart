      ...
      <div className="flex flex-col justify-center bg-white px-6 sm:px-10 lg:px-16 w-full md:max-w-3xl md:mx-auto">
        ...
        <div className="mt-10 flex items-center gap-3 md:justify-center lg:justify-start">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="bg-orange-100 text-orange-500 text-xs px-2 py-1 rounded-md font-semibold">
              VENDOR
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div className="mt-2 flex flex-col md:flex-row gap-3">
              <div className="flex items-center gap-3 border border-gray-400 rounded-xl px-4 py-3 focus-within:border-orange-500 focus-within:ring-2 focus-within:ring-orange-100 w-full">
