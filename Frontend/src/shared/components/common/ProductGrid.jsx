...
import ProductGridSkeleton from "../feedback/skeleton/ProductGridSkeleton";
      ...
      >
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            >
              {product.stock < 1 ? (
                ...
                <>
                  <IoIosWarning /> Only {product.stock} left
                </>
              ) : (
                `${product.stock} left`
              )}
          ...
          <div className="mt-4 flex gap-3">
            <button
              className="flex-1 rounded-lg bg-orange-600 py-2 font-semibold text-white hover:bg-orange-500"
...
const ProductGrid = ({
  ...
  if (loading) return <ProductGridSkeleton count={8} className={gridClass} />;
